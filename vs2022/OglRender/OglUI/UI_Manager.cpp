...
void UI::UI_UIManager::ApplyStyle(EStyle pStyle)
{
    ...
    else if (pStyle == EStyle::UNITY_DARK)
    {
        ...
        colors[ImGuiCol_TitleBg] = ImVec4(0.09f, 0.09f, 0.09f, 0.54f);
        colors[ImGuiCol_TitleBgActive] = ImVec4(0.09f, 0.09f, 0.09f, 0.54f);
        colors[ImGuiCol_TitleBgCollapsed] = ImVec4(0.00f, 0.00f, 0.00f, 1.00f);
        colors[ImGuiCol_MenuBarBg] = ImVec4(0.05f, 0.05f, 0.05f, 0.54f);
