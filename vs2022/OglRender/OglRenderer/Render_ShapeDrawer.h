...
namespace Render
{
	...
	public:
		...
		void DrawGrid(const glm::vec3& pViewPos, const glm::vec3& pColor, int32_t p_gridSize = 50, float pLinear = 0.0f, float pQuadratic = 0.0f, float p_fadeThreshold = 0.0f, float p_lineWidth = 1.0f);
