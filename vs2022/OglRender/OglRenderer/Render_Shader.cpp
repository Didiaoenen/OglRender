...
void Render::Render_Shader::SetUniformVec2(const std::string& pName, const glm::vec2& pVec2)
{
	glUniform2f(GetUniformLocation(pName), pVec2.x, pVec2.y);
}

void Render::Render_Shader::SetUniformVec3(const std::string& pName, const glm::vec3& pVec3)
{
	glUniform3f(GetUniformLocation(pName), pVec3.x, pVec3.y, pVec3.z);
}

void Render::Render_Shader::SetUniformVec4(const std::string& pName, const glm::vec4& pVec4)
{
	glUniform4f(GetUniformLocation(pName), pVec4.x, pVec4.y, pVec4.z, pVec4.w);
}

void Render::Render_Shader::SetUniformMat4(const std::string& pName, const glm::mat4& pMat4)
{
...
uint32_t Render::Render_Shader::GetUniformLocation(const std::string& pName)
{
