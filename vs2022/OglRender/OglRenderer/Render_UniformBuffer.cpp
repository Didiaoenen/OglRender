...
{
	std::map<std::string, Render_Program*> programs = pShader.mPrograms;
...
uint32_t Render::Render_UniformBuffer::GetBlockLocation(Render_Program& pShader, const std::string& pName)
{
